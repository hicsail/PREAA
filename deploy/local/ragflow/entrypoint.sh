...
# Read MCP settings from environment variables with defaults
...
# -----------------------------------------------------------------------------
# Host ID logic:
#   1. Use HOST_ID from environment if set
#   2. Otherwise, use the system hostname if length <= 32
#   3. Otherwise, use the full MD5 hash of the hostname (32 hex chars)
# -----------------------------------------------------------------------------
if [ -z "${HOST_ID}" ]; then
